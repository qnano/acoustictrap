...
% Note: This code uses the saved output data calculated in bead_experiments_fwhm.m 
% and since it uses nonlinear optimization to fit and derive trap stiffesses you may
% need to run multiple times to get the correct output 
